...
<body>
    ...
    {{--  About Section  --}}
    <section class="bg-blue-50 min-h-[80vh] px-6 md:px-20 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
            ...
            <div class="lg:col-span-5 flex flex-col text-[var(--color-spacehub-dark)]">
                ...
                <div class="flex flex-col sm:flex-row gap-4 text-black">
                    <div
                        class="bg-white rounded-xl shadow-md px-4 py-5 flex items-center">
            ...
            <div class="lg:col-span-7 sm:hidden lg:block lg:py-6">
                <img src="{{ asset('images/about-section.png') }}" alt="about images"
    ...
    <div class="min-h-screen bg-gradient-to-br from-white to-blue-100 px-6 md:px-20 py-12">
        ...
        <div class="grid grid-cols-3 px-10 gap-8 min-h-screen py-15">
            @for ($i = 0; $i < 6; $i++)
                <div class="bg-white rounded-2xl shadow-2xl flex flex-col justify-between col-span-1 row-span-1 p-5 transition-all duration-300 hover:scale-105">
                    <!-- Keeping existing content structure -->
                    <img src="{{ asset('images/image.png') }}" alt="wokspace" class="w-full h-">
                    <div class="flex flex-col gap-1 py-2">
                        <p class="text-sm font-bold text-left text-gray-800">PointLab - Private Team/Individual Room</p>
                        ...
                        <div class="flex flex-row items-center gap-1">
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                ...
                                <g id="Clock" clip-path="url(#clip0_918_5589)">
                                    <path id="Icon"
                                        ...
                                        stroke="#8D99AB" stroke-width="2" stroke-linecap="round"
                            ...
                            <p class="text-gray-400 text-sm">08.00 - 22.00 WIB</p>
                        </div>
                    </div>
                    <button
                        class="bg-blue-600 py-2 rounded-lg text-white hover:bg-blue-300 transition duration-300 text-xs">
                        Detail
                    </button>
                </div>
            @endfor
    ...
    <div class="min-h-screen bg-gradient-to-tr from-white to-blue-100 px-6 md:px-20 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-9 gap-8 lg:gap-x-16">
            <div
                ...
                <h2 class="font-jakarta font-bold text-xl lg:text-4xl mb-5">Cara <span
                        class="text-yellow-400">Mudah</span>
    ...
    {{-- Kemitraan section --}}
    <div class="bg-gradient-to-br from-white to-blue-100 min-h-[80vh] px-6 md:px-20 py-12">
        <div class="grid grid-cols-2">
            <div class="col-span-1 flex flex-col lg:gap-5">
                <div class="bg-[var(--color-spacehub-dark)] px-3 py-2 text-white rounded-full max-w-[25%] text-center">
                    Kemitraan
                </div>
                ...
                <a href=""
                    class="font-jakarta font-bold border-2 text-center border-[var(--color-spacehub-dark)] text-[var(--color-spacehub-dark)] rounded-md max-w-[35%] px-3 py-2 mt-5 hover:bg-[var(--color-spacehub-dark)] hover:text-white transition duration-300">
                    Lihat Tawaran
                </a>
            </div>
    ...
    {{-- CTA Section --}}
    <div class="bg-gradient-to-tr from-white to-blue-100 min-h-[60vh] px-6 md:px-20 py-12 flex flex-col items-center justify-center gap-8">
        <h1 class="text-[var(--color-spacehub-dark)] text-2xl lg:text-3xl font-bold text-center">Siap temukan ruang kerja yang pas? Yuk mulai sekarang</h1>
        
        <a href="#" class="text-white bg-[var(--color-spacehub-dark)] px-6 py-3 rounded-full hover:bg-[var(--color-spacehub)] transition-colors duration-300">
            Jelajahi Tempat
        </a>
